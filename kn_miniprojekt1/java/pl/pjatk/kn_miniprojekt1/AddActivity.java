...
public class AddActivity extends DefaultActivity {
    ...
    private void insertData() {
        ...
        /* Broadcast newly added product */
        broadcastData(name,price,amount);
    }

    public void broadcastData(EditText name, EditText price, EditText amount) {
        Intent broadcastIntent = new Intent();
        broadcastIntent.setAction("pl.pjatk.kn_miniprojekt1.CUSTOM_INTENT");
        broadcastIntent.putExtra(ProductsContract.ProductColumns.NAME, name.getText().toString());
        broadcastIntent.putExtra(ProductsContract.ProductColumns.PRICE, price.getText().toString());
        broadcastIntent.putExtra(ProductsContract.ProductColumns.AMOUNT, amount.getText().toString());
